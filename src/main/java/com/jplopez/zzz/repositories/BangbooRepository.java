...
public interface BangbooRepository extends JpaRepository<Bangboo, String> {
  ...
  List<Bangboo> findByBangbooId(String bangbooId);
  ...
  List<Bangboo> findByFactionIgnoreCase(String faction);

  List<Bangboo> findByNameOrRarityOrFaction(String name, Rarity rarity, String faction);
